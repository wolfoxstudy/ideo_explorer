...
<!-- Example scripts go here -->
    <link class="include" type="text/css" href="https://ajax.cat.net/ajax/libs/jqueryui/1.10.0/themes/smoothness/jquery-ui.css" rel="Stylesheet" /> 
...
<!-- Additional plugins go here -->
    ...
    <script class="include" type="text/javascript" src="https://ajax.cat.net/ajax/libs/jqueryui/1.10.0/jquery-ui.min.js"></script>
